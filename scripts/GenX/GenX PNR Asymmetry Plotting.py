...
func=lambda r:np.sqrt((1.0/(r[up_c]+r[down_c])-(r[up_c]-r[down_c])/(r[up_c]+r[down_c])**2)**2*r[up_ec]**2+
                      (-1.0/(r[up_c]+r[down_c])-(r[up_c]-r[down_c]) / (r[up_c]+r[down_c])**2)**2*r[down_ec]**2)
