...
d.setas = "xyey"
d.plot(fmt=["r.", "b-"])
d.annotate_fit(SF.fowlerNordheim, x=0.2, y=0.6, prefix="fowlerNordheim", fontdict={"size": "x-small", "color": "blue"})
...
d.setas = "x...y"
d.plot(fmt="g-")
d.annotate_fit(fit, x=0.2, y=0.2, prefix="FowlerNordheim", fontdict={"size": "x-small", "color": "green"})
