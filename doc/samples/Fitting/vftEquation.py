...
d.yscale="log"
d.ylim=(1E-35,1E10)
d.annotate_fit(SF.vftEquation,x=290,y=100,fontdict={"size":"x-small"},mode="eng")

d.annotate_fit(SF.VFTEquation,x=240,y=100,prefix="VFTEquation",fontdict={"size":"x-small"},mode="eng")
