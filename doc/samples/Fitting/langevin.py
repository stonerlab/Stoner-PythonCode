...
d.annotate_fit(func,x=-0.01,y=-0.75,fontdict={"size":"x-small"},mode="eng")
d.annotate_fit(SF.Langevin,x=0.00025,y=-0.75,fontdict={"size":"x-small"},prefix="Langevin",mode="eng")
