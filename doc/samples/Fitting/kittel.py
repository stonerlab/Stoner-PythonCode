...
d=Data(B,G,dG,setas="xye",column_headers=["Field $Oe$",r"$\nu (Hz)$",r"\delta $\nu (Hz)$"])
...
d.annotate_fit(SF.kittelEquation,x=4000,y=2E8,fontdict={"size":"x-small"},mode="eng")
d.annotate_fit(SF.KittelEquation,x=20000,y=2E8,fontdict={"size":"x-small"},prefix="KittelEquation",mode="eng")
d.title="Kittel Fit"
