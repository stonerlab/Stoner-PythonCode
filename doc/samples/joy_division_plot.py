...
fldr=RigakuFolder()
fldr.load_files("L2_2 5mm length limiting slit Offspec RSM 0p05 2t step_0SecsAnneal.ras")
...
total.column_headers=[r"$\omega(^\circ)$",r"$2\theta (^\circ)5",r"$\log_{10}(Counts)$"]
#Do the plot
