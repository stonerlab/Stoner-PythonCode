...
======================
    ...
    - Version 0.9 supportes Python 2.7, 3.5, 3.6 and 3.7. The final release of 0.9 also supports Python 3.8
    - Version 0.10 does *not* support Python 2.7 or 3.5. The supported versions of Pythin are 3.6, 3.7 and 3.8
...
users of the package, the :py:class:`Stoner.DataFolder` class is probably all that is required to be improted.

Stoner.Fit Module depricated
============================
...
Stoner.FileFormats Module depricated
====================================
...
now been superceded by the :py:mod:`Stoner.formats` package which groups the fileformats into different sub-modules.
...
The original write of the :py:mod:`Stoner.Image` package developped a subclass of numpy array wioth metadata - :py:class:`Stoner.Imnage.ImageArray`
