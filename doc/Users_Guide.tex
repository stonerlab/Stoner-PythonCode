...
\warning{If the filename attribute has not been set \eg if the DataFile object was created from scratch, then the \textbf{DataFile.save} method will fail. This will be changed to cause a dialog box to be raised.}
