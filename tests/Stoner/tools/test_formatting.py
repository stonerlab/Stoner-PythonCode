...
def test_format_error():
    ...
    assert formatting.format_error(value,error,fmt="html",mode="sci").strip()=="1.23&plusmin;0.02&times; 10<sup>-6</sup>"
    ...
    assert formatting.format_error(value,error,fmt="latex",mode="eng",units="<bad\hr>",escape=True).strip()==r"$1.23\pm 0.02\,\mathrm{\mu}\mathrm{\textlessbad\textbackslash{}hr\textgreater}$"
...
def test_format_value():
    ...
    assert formatting.format_error(value,error,fmt="html",mode="sci").strip()=="1.2345000000000002&times; 10<sup>-6</sup>"
    assert formatting.format_error(value,error,fmt="latex",mode="sci").strip()==r"$1.2345000000000002\times 10^{-6}$"
    ...
    assert formatting.format_error(value,error,fmt="latex",mode="eng",units="<bad\hr>",escape=True).strip()==r"$1.2345000000000002\mathrm{\mu}\mathrm{\textlessbad\textbackslash{}hr\textgreater}$"
