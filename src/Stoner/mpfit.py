## Automatically adapted for numpy.oldnumeric Jan 08, 2011 by ipython
# Local copy for Stoner module that uses numpy and not numeric
#
# $Id: mpfit.py,v 1.1 2011/01/08 20:57:41 cvs Exp $
#
# $Log: mpfit.py,v $
# Revision 1.1  2011/01/08 20:57:41  cvs
# Add a local copy of mpfit that has been autohacked to work with numpy - Gavin
#
#
