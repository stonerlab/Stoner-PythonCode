# -*- coding: utf-8 -*-
"""Provide the base classes and functions for the :py:class:`~Stoner.folders.mixins.DataFolder` class."""
...
class BaseFolder(MutableSequence):
    ...
    @property
    def type(self):
        """Return the (sub)class of the :py:class:`Stoner.core.base.metadataObject` instances."""
        return self._type
