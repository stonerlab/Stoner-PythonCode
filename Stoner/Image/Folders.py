...
def _load_ImageArray(f,img_num=0, **kwargs):
...
def _average_list(listob):
    ...
    elif isinstance(typex, (str, unicode)):
...
class ImageFolder(DiskBssedFolder,baseFolder):
    ...
    def __init__(self, *args,**kargs):
        ...
        self.type=kargs.pop("type",ImageArray)
...
class ImageStack(metadataObject):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(ImageStack, self).__init__(  \
                    metadata=kwargs.pop('metadata',None)) #initialise metadata
        ...
        self.metadata_info = kwargs.pop('metadata_info', 'list')
        copyarray = kwargs.pop('copyarray', False)
        ...
        if len(args)==0:
            ...
            if isinstance(images, ImageStack):
                ...
                if all(types):        
                    ...
                    raise ValueError('Expected a list of ImageArray or ndarray type, received {}'.format(type(images[types.index(False)])))
            else:
               raise ValueError('Expected a list of ImageArray or ndarray type, received {}'.format(type(images[types.index(False)])))         
...
class MaskStack(KerrStack):
    ...
    """
    def __init__(self, *args, **kwargs):
        super(MaskStack,self).__init__(*args, **kwargs)
